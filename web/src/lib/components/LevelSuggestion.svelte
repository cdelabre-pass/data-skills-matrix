...
<div class="card p-6">
	...
	<div class="text-center mb-6">
		...
		<p
			class="text-sm {confidenceColor} mt-2 flex items-center justify-center gap-2"
		>
			<svg
				class="w-4 h-4"
				fill="none"
	...
	<div class="relative pt-4">
		<div class="flex justify-between mb-2">
			{#each levels as l, i}
				<div class="flex flex-col items-center">
					<div
						class="w-4 h-4 rounded-full transition-all duration-300 {i <=
						levelIndex
		...
		<div
			class="absolute top-6 left-0 right-0 h-1 bg-base-700 -z-10 rounded-full overflow-hidden"
		>
			<div
